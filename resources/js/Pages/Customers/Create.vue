...
<template>
    ...
    <h1 class="mb-6 text-4xl font-semibold tracking-tight text-slate-900 dark:text-white">Add Customer</h1>
    ...
    <form class="space-y-6" @submit.prevent="submit">
        ...
        <BaseCard title="Referral">
            <BaseInput v-model="form.referral_code" label="Referred by (referral code, optional)" :error="form.errors.referral_code" />
        </BaseCard>

        <BaseButton type="submit" :disabled="form.processing">Save Customer</BaseButton>
    </form>
</template>
